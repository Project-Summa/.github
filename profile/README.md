...
| | | |
|:---:|:---|:---|
| 📴 | **Local First** | Everything works offline. No internet connection required. |
| 🗂️ | **User Owns the Data** | Your financial data belongs to you. Export it anytime. |
| 🔒 | **Privacy by Default** | No telemetry. No tracking. No analytics. |
| ☁️ | **Cloud is Optional** | Sync across devices when you want. Stay offline when you don't. |
...
Summa is in **Phase 0 — Foundation**. We are establishing architecture, documentation and development standards before feature implementation begins.
